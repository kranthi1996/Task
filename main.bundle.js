...
module.exports = "<h1 class=\"text-center primary \">\n  Welcome to our amazing application\n\n</h1>\n<div class=\"text-center container\">\n<a routerLink=\"/setting\" class=\"btn btn-primary\">Search</a>\n<a routerLink=\"/home\" class=\"btn btn-primary\">Details</a>\n\n</div>\n<router-outlet></router-outlet>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__setting_setting_component__ = __webpack_require__("../../../../../src/app/setting/setting.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'setting', component: __WEBPACK_IMPORTED_MODULE_5__setting_setting_component__["a" /* SettingComponent */]
    },
    {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__setting_setting_component__["a" /* SettingComponent */],
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__weather_service__["a" /* WeatherService */]],
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this._weatherService.getWeather(this.location.city, this.location.code).subscribe(function (response) {
...
var SettingComponent = (function () {
    ...
    SettingComponent.prototype.saveForm = function () {
        var location = {
            city: this.city,
            state: this.code
        };
...
var WeatherService = (function () {
    function WeatherService(http) {
        this.http = http;
        this.apiKey = 'fc0c4e1ec49d0c022df6519574a1a2ca';
        this.url = 'http://api.openweathermap.org/data/2.5/forecast?q=';
    }
    WeatherService.prototype.getWeather = function (city, code) {
        return this.http.get(this.url + city + ',' + code + '&APPID=' + this.apiKey).map(function (res) { return res.json(); });
    };
